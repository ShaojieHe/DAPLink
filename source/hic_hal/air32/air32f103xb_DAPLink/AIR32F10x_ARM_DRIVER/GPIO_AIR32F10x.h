 ...
 * $Revision:    V1.0
 *
 * Project:      GPIO Driver definitions for AIRM2M  AIR32F10x
 * -------------------------------------------------------------------- */

#ifndef __GPIO_AIR32F10X_H
#define __GPIO_AIR32F10X_H
...
typedef enum {
  ...
  AFIO_SWJ_FULL_NO_NJTRAIRM2M     = AFIO_FUNC_DEF (24, 7, 1, 0),
