 ...
 * $Revision:    V1.0
 *  
 * Project:      DMA Driver for AIRM2M  AIR32F10x
 * -------------------------------------------------------------------- */
...
#if defined(AIR32F10X_HD)    || defined(AIR32F10X_XL) || \
    defined(AIR32F10X_HD_VL) || defined(AIR32F10X_CL)
  /* DMA2 peripheral exists on HD, XL, HD_VL and CL devices */
  #define AIR32F10X_ENABLE_DMA2
#endif

/// DMA Variables
static uint8_t DMA1_Channel;             // Used DMA1 Channels
#if defined (AIR32F10X_ENABLE_DMA2)
...
#if defined(AIR32F10X_HD_VL) || defined (AIR32F10X_CL)
/**
